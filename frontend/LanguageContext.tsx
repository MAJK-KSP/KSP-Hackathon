...
const dictionary: Record<string, string> = {
  ...
  "Crime Types": "ಅಪರಾಧದ ವಿಧಗಳು",
  "Filter Cases": "ಪ್ರಕರಣಗಳನ್ನು ಫಿಲ್ಟರ್ ಮಾಡಿ",
  "Select Station": "ಠಾಣೆಯನ್ನು ಆಯ್ಕೆಮಾಡಿ",
  "Active Cases GIS Map": "ಸಕ್ರಿಯ ಪ್ರಕರಣಗಳ ಜಿಐಎಸ್ ನಕ್ಷೆ",
  "Live connection to Supabase DB active": "ಸುಪಬೇಸ್ ಡಿಬಿಗೆ ಲೈವ್ ಸಂಪರ್ಕ ಸಕ್ರಿಯವಾಗಿದೆ",
  "Connection failed. Fallback to Local DB": "ಸಂಪರ್ಕ ವಿಫಲವಾಗಿದೆ. ಲೋಕಲ್ ಡಿಬಿಗೆ ಬದಲಾಯಿಸಲಾಗಿದೆ",
  "Interactive Map": "ಸಂವಾದಾತ್ಮಕ ನಕ್ಷೆ",
  "Heatmap Density": "ಶಾಖದ ನಕ್ಷೆ ಸಾಂದ್ರತೆ",
  "Marker Clusters": "ಮಾರ್ಕರ್ ಕ್ಲಸ್ಟರ್‌ಗಳು",
  "Search Cases": "ಪ್ರಕರಣಗಳನ್ನು ಹುಡುಕಿ",
  "Active Cases": "ಸಕ್ರಿಯ ಪ್ರಕರಣಗಳು",
  "Solved Cases": "ಪರಿಹರಿಸಲಾದ ಪ್ರಕರಣಗಳು",
  "Unsolved Cases": "ಪರಿಹರಿಸದ ಪ್ರಕರಣಗಳು",
  "No cases found matching these filters.": "ಈ ಫಿಲ್ಟರ್‌ಗಳಿಗೆ ಹೊಂದಿಕೆಯಾಗುವ ಯಾವುದೇ ಪ್ರಕರಣಗಳು ಕಂಡುಬಂದಿಲ್ಲ.",
  "Search Keyword": "ಹುಡುಕಾಟದ ಕೀವರ್ಡ್",
  "Search by FIR ID or landmark...": "ಎಫ್ಐಆರ್ ಐಡಿ ಅಥವಾ ಹೆಗ್ಗುರುತಿನ ಮೂಲಕ ಹುಡುಕಿ...",
  "All Categories": "ಎಲ್ಲಾ ವರ್ಗಗಳು",
  "All Stations": "ಎಲ್ಲಾ ಠಾಣೆಗಳು",
  "Start Date": "ಪ್ರಾರಂಭ ದಿನಾಂಕ",
  "End Date": "ಕೊನೆಯ ದಿನಾಂಕ",
  ...
  "Cyber Crime / Fraud": "ಸೈಬರ್ ಅಪರಾಧ / ವಂಚನೆ",
  "Assault / Brawl": "ದಾಳಿ / ಗಲಾಟೆ",
  "Traffic Violation": "ಸಂಚಾರ ನಿಯಮ ಉಲ್ಲಂಘನೆ",
  "Robbery": "ದರೋಡೆ",
  "Public Nuisance": "ಸಾರ್ವಜನಿಕ ಉಪಟಳ",
  "Vandalism / Property Damage": "ವಿಧ್ವಂಸಕ ಕೃತ್ಯ / ಆಸ್ತಿ ಹಾನಿ",
  "Landmark": "ಹೆಗ್ಗುರುತು",
  "Date": "ದಿನಾಂಕ",
  "Station": "ಪೊಲೀಸ್ ಠಾಣೆ",
  "Crime Distribution": "ಅಪರಾಧ ಹಂಚಿಕೆ",
  "Cases in this Area": "ಈ ಪ್ರದೇಶದ ಪ್ರಕರಣಗಳು",
  "more cases": "ಹೆಚ್ಚಿನ ಪ್ರಕರಣಗಳು",
  ...
  // Network Visualizer Translations
  "TACTICAL CRIMINAL INTELLIGENCE NETWORK": "ತಾಂತ್ರಿಕ ಅಪರಾಧ ಗುಪ್ತಚರ ಜಾಲ",
  "100% GROUND TRUTH": "100% ಮೂಲ ಸತ್ಯಾಂಶ",
  "Entities": "ಸಂಸ್ಥೆಗಳು",
  "Active Links": "ಸಕ್ರಿಯ ಲಿಂಕ್‌ಗಳು",
  "High Risk": "ಹೆಚ್ಚಿನ ಅಪಾಯ",
  "Syndicates": "ಸಿಂಡಿಕೇಟ್‌ಗಳು",
  "+ Add Entity": "+ ಸಂಸ್ಥೆಯನ್ನು ಸೇರಿಸಿ",
  "Export Dossier": "ಡಾಕ್ಯುಮೆಂಟ್ ರಫ್ತುಮಾಡಿ",
  "Search suspect, bank account, vehicle plate...": "ಸಂದೇಹಾಸ್ಪದ ವ್ಯಕ್ತಿ, ಬ್ಯಾಂಕ್ ಖಾತೆ, ವಾಹನ ಸಂಖ್ಯೆಯನ್ನು ಹುಡುಕಿ...",
  "⚡ High Risk": "⚡ ಹೆಚ್ಚಿನ ಅಪಾಯ",
  "💳 Financial Trail": "💳 ಹಣಕಾಸು ಹಾದಿ",
  "👥 Co-Accused Links": "👥 ಸಹ-ಆರೋಪಿ ಲಿಂಕ್‌ಗಳು",
  "🚗 Vehicle Tracks": "🚗 ವಾಹನ ಟ್ರ್ಯಾಕ್‌ಗಳು",
  "🚨 Spot Syndicates": "🚨 ಸಿಂಡಿಕೇಟ್‌ಗಳನ್ನು ಗುರುತಿಸಿ",
  "Filter Settings": "ಫಿಲ್ಟರ್ ಸೆಟ್ಟಿಂಗ್‌ಗಳು",
  "Force Physics": "ಫೋರ್ಸ್ ಫಿಸಿಕ್ಸ್",
  "Ring": "ರಿಂಗ್",
  "Grid": "ಗ್ರಿಡ್",
  "Fit View": "ಫಿಟ್ ವೀಕ್ಷಣೆ",
  "Ground-Truth Inspector": "ಮೂಲ-ಸತ್ಯ ಪರಿಶೀಲಕ",
  "EVIDENCE": "ಸಾಕ್ಷ್ಯಾಧಾರ",
  "PROFILE": "ಪ್ರೊಫೈಲ್",
  "ANALYTICS": "ವಿಶ್ಲೇಷಣೆ",
  "TIMELINE": "ಸಮಯರೇಖೆ",
  "Threat Risk Rating": "ಬೆದರಿಕೆ ಅಪಾಯದ ರೇಟಿಂಗ್",
  "Verbatim Ground Truth Evidence (`brieffacts`)": "ಮೂಲ ಸತ್ಯ ಸಾಕ್ಷ್ಯದ ಸಾರಾಂಶ (`brieffacts`)",
  "1st-Degree Connected Entities": "1ನೇ ಹಂತದ ಸಂಪರ್ಕಿತ ಸಂಸ್ಥೆಗಳು",
  "Focus": "ಗಮನಹರಿಸಿ",
  "🚨 Flag for Police Surveillance": "🚨 ಪೊಲೀಸ್ ಕಾವಲಿಗೆ ಗುರುತಿಸಿ",
  "Remove Surveillance Flag": "ಕಾವಲು ಫ್ಲ್ಯಾಗ್ ತೆರವುಗೊಳಿಸಿ",
  "Expand 2-Degree Network Path": "2ನೇ ಹಂತದ ನೆಟ್‌ವರ್ಕ್ ವಿಸ್ತರಿಸಿ",
  "Add New Entity to Investigation": "ತನಿಖೆಗೆ ಹೊಸ ಸಂಸ್ಥೆಯನ್ನು ಸೇರಿಸಿ",
  "Entity Category:": "ಸಂಸ್ಥೆಯ ವರ್ಗ:",
  "Primary Label / Name:": "ಪ್ರಾಥಮಿಕ ಲೇಬಲ್ / ಹೆಸರು:",
  "Threat Risk Rating:": "ಬೆದರಿಕೆ ಅಪಾಯದ ರೇಟಿಂಗ್:",
  "Link to Existing Entity (Optional):": "ಹಾಲಿ ಸಂಸ್ಥೆಗೆ ಲಿಂಕ್ (ಐಚ್ಛಿಕ):",
  "Relationship Type:": "ಸಂಬಂಧದ ವಿಧ:",
  "Verbatim Evidence Notes:": "ಸಾಕ್ಷ್ಯಾಧಾರ ಟಿಪ್ಪಣಿಗಳು:",
  "Cancel": "ರದ್ದುಗೊಳಿಸಿ",
  "Save & Insert into Graph": "ಉಳಿಸಿ ಮತ್ತು ಗ್ರಾಫ್‌ಗೆ ಸೇರಿಸಿ",
  "Network Analysis": "ನೆಟ್‌ವರ್ಕ್ ವಿಶ್ಲೇಷಣೆ",
  "Tactical Network Visualizer": "ತಾಂತ್ರಿಕ ನೆಟ್‌ವರ್ಕ್ ದೃಶ್ಯೀಕರಣ",
  "Filter Settings Panel": "ಫಿಲ್ಟರ್ ಸೆಟ್ಟಿಂಗ್ ಪ್ಯಾನೆಲ್",
  "Entity Category": "ಸಂಸ್ಥೆಯ ವರ್ಗ",
  "Threat Risk Threshold:": "ಬೆದರಿಕೆ ಅಪಾಯದ ಮಿತಿ:",
  "Link Verification Score:": "ಲಿಂಕ್ ಪರಿಶೀಲನೆ ಅಂಕ:",
  "All Threat Levels": "ಎಲ್ಲಾ ಬೆದರಿಕೆ ಮಟ್ಟಗಳು",
  "Critical Risk (9-10/10)": "ಅತಿ ಹೆಚ್ಚಿನ ಅಪಾಯ (9-10/10)",
  "High Risk (7-8/10)": "ಹೆಚ್ಚಿನ ಅಪಾಯ (7-8/10)",
  "Medium Risk (5-6/10)": "ಮಧ್ಯಮ ಅಪಾಯ (5-6/10)",
  "Low Risk (<5/10)": "ಕಡಿಮೆ ಅಪಾಯ (<5/10)",
  "All Links (100% & AI)": "ಎಲ್ಲಾ ಲಿಂಕ್‌ಗಳು (100% ಮತ್ತು AI)",
  "100% Verbatim DB Matches": "100% ನಿಖರ DB ಪಂದ್ಯಗಳು",
  "AI Pattern Associations": "AI ಮಾದರಿ ಸಂಯೋಜನೆಗಳು",
  "Reset All Filters": "ಎಲ್ಲಾ ಫಿಲ್ಟರ್‌ಗಳನ್ನು ಮರುಹೊಂದಿಸಿ",
  "CO_ACCUSED": "ಸಹ-ಆರೋಪಿ",
  "TRANSFERRED_FUNDS": "ಹಣ ವರ್ಗಾವಣೆ",
  "SPOTTED_AT": "ಕಂಡುಬಂದ ಸ್ಥಳ",
  "VICTIM_OF": "ಸಂತ್ರಸ್ತ",
  "ASSOCIATED_VEHICLE": "ಸಂಬಂಧಿತ ವಾಹನ",
  "ACCUSED / SUSPECT": "ಆರೋಪಿ / ಶಂಕಿತ",
  "VICTIM": "ಸಂತ್ರಸ್ತ",
  "LOCATION / HOTSPOT": "ಸ್ಥಳ / ಹಾಟ್‌ಸ್ಪಾಟ್",
  "FINANCIAL ACCOUNT / PHONE": "ಹಣಕಾಸು ಖಾತೆ / ಫೋನ್",
  "VEHICLE": "ವಾಹನ",
  "CASE INCIDENT (FIR)": "ಪ್ರಕರಣದ ಘಟನೆ (FIR)"
};
